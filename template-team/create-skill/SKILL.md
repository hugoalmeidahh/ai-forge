...
3. Inform the user:
   > This skill was created locally. If it should be permanent and shared across all projects, submit it to the official package repository at `@core/ai-prompts`.
